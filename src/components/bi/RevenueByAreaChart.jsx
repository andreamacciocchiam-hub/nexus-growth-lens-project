...
const COLORS = { '2024': '#9ca3af', '2025': '#8b5cf6', '2026': '#3b82f6' };
const AREAS = ['MNO','SNO','LNO','MNE','SNE','LNE','MCS','SLCE','SLCS','IC'];

export default function RevenueByAreaChart({ data }) {
  ...
  const chartData = AREAS.map(area => {
    ...
    return {
      area,
      '2024': d24?.serv_i_anno || 0,
      '2025': d25?.serv_i_anno || 0,
      '2026': d26?.serv_i_anno || 0,
    };
